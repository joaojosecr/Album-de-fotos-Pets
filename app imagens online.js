    ...
    fetch('db.json')
        ...
        .then(db => {
            ...
            <div class="row " >
                ...
                <div class="col-md-12">
                   <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                        <img class="card-img-right flex-auto d-none d-lg-block" alt="Thumbnail [200x250]" src="${pet.imagem.foto[12]}" style="width: 200px; height: 250px;">
            ...
            for ( i = 1; i < 13; i++) {
                ...
                str += `<div class="col-xl-3 col-lg-4 col-md-6 border border-0" >
                <button id="${i}" style="width: 100%; " onclick="exibeCarrosselAlbum(${i},'${pet.imagem}')" class="mostrarBtn card mb-4 text-white bg-dark">
                    <img class="card-img-top" src="${pet.imagem.foto[i-1]}" alt="Card image cap" style="height: 250px;">
...
function exibeCarrosselAlbum(id, imagem){
                            ...
                            for ( i=0; i<12;i++){
                                if (i+1==id){
                                    ...
                                    `<div class="carousel-item active" id="slide${i}">
                                        <img src="${imagem.foto[i]}" class="d-block w-100"  alt="..." >
                                    </div>`
                                } else {
